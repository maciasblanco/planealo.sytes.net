        ...
        <div class="col-md-3">
            <div class="info-box bg-warning">
                <div class="info-box-content">
                    ...
                    <span class="info-box-detail">Quincenas por pagar</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabla-atletas">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="text-center">Quincenas Adelantadas</th>
                        ...
                        <tbody>
                            <?php foreach ($atletasConEstadisticas as $index => $item): ?>
                                ...
                                $quincenasPagadas = $montoPagado / app\models\AportesSemanales::MONTO_QUINCENAL;
                                $quincenasDeuda = $montoDeuda / app\models\AportesSemanales::MONTO_QUINCENAL;
                                ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <small class="text-muted">
                                            <?= number_format($quincenasPagadas, 1) ?> quincenas
                                        </small>
                                    </td>
                                    <td class="text-center">
                                        <?php if ($montoDeuda > 0): ?>
                                            ...
                                            <br>
                                            <small class="text-muted">
                                                <?= number_format($quincenasDeuda, 1) ?> quincenas
                                            </small>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center">
                                        <?php if ($montoAdelantado > 0): ?>
                                            ...
                                            <br>
                                            <small class="text-muted">
                                                <?= number_format($quincenasAdelantadas, 1) ?> quincenas
                                            </small>
                                        <?php else: ?>
                    ...
                    <div class="col-md-12">
                        <div class="alert alert-light">
                            <small>
                                ...
                                Monto quincenal: $<?= number_format(app\models\AportesSemanales::MONTO_QUINCENAL, 2) ?> | 
