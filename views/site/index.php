            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="school-selector-widget mb-4">
                        <h5 class="text-light mb-3">Selecciona tu escuela</h5>
                        <div class="row g-2">
                            <div class="col-md-8">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-card">
                        <img src="<?= Yii::getAlias('@web') ?>/img/team/director.jpg" 
                             class="team-photo" 
                             alt="Director del Proyecto"
                             onerror="this.src='<?= Yii::getAlias('@web') ?>/img/team/placeholder.jpg'">
                        <h4 class="h5 mb-2">Lic. Carlos Rodríguez</h4>
                        <div class="team-role">Director del Proyecto</div>
                        <p class="text-muted small">
                            Más de 15 años de experiencia en gestión deportiva y administración de proyectos tecnológicos.
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-card">
                        <img src="<?= Yii::getAlias('@web') ?>/img/team/analista.jpg" 
                             class="team-photo" 
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-card">
                        <img src="<?= Yii::getAlias('@web') ?>/img/team/programador.jpg" 
                             class="team-photo" 
                             alt="Programador"
                             onerror="this.src='<?= Yii::getAlias('@web') ?>/img/team/placeholder.jpg'">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-card">
                        <img src="<?= Yii::getAlias('@web') ?>/img/team/tester.jpg" 
                             class="team-photo" 
                             alt="Tester QA"
                             onerror="this.src='<?= Yii::getAlias('@web') ?>/img/team/placeholder.jpg'">
